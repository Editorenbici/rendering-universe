...
Inventario cerrado. Fuente: `FUNDAMENTOS.md` §II.

| Símbolo | Valor / Definición | Historia |
|---------|-------------------|----------|
...
- **[ℛ] = 1** — adimensional. ℛ cuenta resolución, no tiene unidades.
- **h** — profundidad de cadena (longest chain length desde el post).
- **w** — anchura de anticadena.
- **u_μ** = ∂_μ h / |∂h| — vector tiempo operativo, definido desde la estructura causal.
