...
The action for the resolution field $\phi$ (with units of mass, representing the inverse lattice spacing) is:
\begin{equation}
S = \int \dd^4x \sqrt{-g} \left[ \frac{\Mpl^2}{2}(\phi \lP)^2 R - \frac{1}{2}(\partial\phi)^2 - V(\phi) \right]
\end{equation}
where $V(\phi) \approx \Mpl^4 (\lP \phi)^{-4}$.
...
\bibitem{Sorkin} R. Sorkin, "Causal Sets: Discrete Gravity," arXiv:gr-qc/0309009.
\bibitem{Banks} T. Banks, "Cosmological constant as a manifestation of the cyclicity of time," Phys. Scripta T117, 56.
...
\bibitem{CMBS4} CMB-S4 Collaboration, "CMB-S4 Science Book, First Edition," arXiv:1610.02743.
