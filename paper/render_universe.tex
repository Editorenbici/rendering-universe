...
The stellar mass density \citep{labbe2023} follows from the resolution scaling. From Postulate 3 ($1+z = \mathcal{R}_0/\mathcal{R}$):
\begin{equation}
{
m SMD}(z) \approx {
m SMD}(0) \left(\frac{\mathcal{R}(z)}{\mathcal{R}_0}
ight)^3 = {
m SMD}(0)\,(1+z)^{-3}
\label{eq:smd}
\end{equation}
