...
def generate_pixel():
    ...
    outfile = os.path.join(output_dir, "universe_pixel_stage.pdf")
...
def generate_structure():
    ...
    outfile = os.path.join(output_dir, "universe_structure_stage.pdf")
    plt.savefig(outfile, bbox_inches='tight', pad_inches=0, dpi=dpi)
    print(f"Generated: {outfile}")
    plt.close()
...
def generate_8k_galaxy():
    ...
    outfile = os.path.join(output_dir, "universe_8k_stage.pdf")
    plt.savefig(outfile, bbox_inches='tight', pad_inches=0, dpi=dpi)
    print(f"Generated: {outfile}")
    plt.close()
